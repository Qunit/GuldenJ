...
public class PeerGroup implements TransactionBroadcaster {
     ...
     */
    public void setUserAgent(String name, String version, @Nullable String comments, @Nullable String baseSubVer) {
