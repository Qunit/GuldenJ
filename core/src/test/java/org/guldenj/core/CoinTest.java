...
public class CoinTest {
    ...
    public void testToFriendlyString() {
        assertEquals("1.00 NLG", COIN.toFriendlyString());
        assertEquals("1.23 NLG", valueOf(1, 23).toFriendlyString());
        assertEquals("0.001 NLG", COIN.divide(1000).toFriendlyString());
        assertEquals("-1.23 NLG", valueOf(1, 23).negate().toFriendlyString());
    }
