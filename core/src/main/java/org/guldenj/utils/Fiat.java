...
/**
 * Represents a monetary fiat value. It was decided to not fold this into {@link org.guldenj.core.Coin} because of type
...
public final class Fiat implements Monetary, Comparable<Fiat>, Serializable {
    ...
    /**
     * <p>
     * Returns the value as a plain string denominated in NLG. The result is unformatted with no trailing zeroes. For
     * instance, a value of 150000 satoshis gives an output string of "0.0015" NLG
     * </p>
     */
    ...
    public String toPlainStringWithExponent(final int exponent)
    {
	return MonetaryFormat.RAW.minDecimals(exponent).format(this).toString();
    }
