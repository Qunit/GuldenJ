...
# Change this to point to where you have a copy of the guldenj.jar
sys.path.append(r"/path/to/guldenj-core-0.12-bundled.jar")
...
if __name__ == "__main__":
    params = org.guldenj.params.TestNet3Params.get()
