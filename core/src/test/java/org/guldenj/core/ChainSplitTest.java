...
import org.guldenj.store.MemoryBlockStore;
import org.guldenj.testing.FakeTxBuilder;
import org.guldenj.utils.BriefLogFormatter;
...
public class ChainSplitTest {
    ...
    public void testForking1() throws Exception {
        ...
        Block b1 = unitTestParams.getGenesisBlock().createNextBlock(coinsTo, null);
        Block b2 = b1.createNextBlock(coinsTo, null);
        ...
        Block b3 = b1.createNextBlock(someOtherGuy, null);
        ...
        //                  |-> b7 (x)
        //                  \-> b8 (x)
        Block b7 = b1.createNextBlock(coinsTo, null);
        assertTrue(chain.add(b7));
        Block b8 = b1.createNextBlock(coinsTo, null);
        ...
        assertTrue(chain.add(b3.createNextBlock(someOtherGuy, null)));
        Threading.waitForUserCode();
        ...
        Block b5 = b2.createNextBlock(coinsTo, null);
        Block b6 = b5.createNextBlock(coinsTo, null);
    ...
    public void testForking2() throws Exception {
        ...
        Block b1 = unitTestParams.getGenesisBlock().createNextBlock(someOtherGuy, null);
        Block b2 = b1.createNextBlock(someOtherGuy, null);
        assertTrue(chain.add(b1));
        assertTrue(chain.add(b2));
        //     genesis -> b1 -> b2
        //                  \-> b3 -> b4
        assertEquals(Coin.ZERO, wallet.getBalance());
        Block b3 = b1.createNextBlock(coinsTo, null);
        Block b4 = b3.createNextBlock(someOtherGuy, null);
        assertTrue(chain.add(b3));
        assertEquals(Coin.ZERO, wallet.getBalance());
    ...
    public void testForking5() throws Exception {
        ...
        // genesis -> b1
        //         -> b2
        Block b2 = unitTestParams.getGenesisBlock().createNextBlock(coinsTo, null);
        ...
        //          -> b2 -> b3
        Block b3 = b2.createNextBlock(someOtherGuy, null);
        chain.add(b3);
        assertEquals(FIFTY_COINS, wallet.getBalance());
    ...
    public void testDoubleSpendOnFork() throws Exception {
        ...
        Block b2 = b1.createNextBlock(new ECKey().toAddress(unitTestParams), null);
        b2.addTransaction(t1);
        b2.solve();
        chain.add(roundtrip(b2));

        // Now we make a double spend become active after a re-org.
        Block b3 = b1.createNextBlock(new ECKey().toAddress(unitTestParams), null);
        b3.addTransaction(t2);
        b3.solve();
        chain.add(roundtrip(b3));  // Side chain.
        Block b4 = b3.createNextBlock(new ECKey().toAddress(unitTestParams), null);
    ...
    public void testDoubleSpendOnForkPending() throws Exception {
        ...
        Block b5 = b2.createNextBlock(new ECKey().toAddress(unitTestParams), null);
        chain.add(b5);
        Block b6 = b5.createNextBlock(new ECKey().toAddress(unitTestParams), null);
        chain.add(b6);
    ...
    public void txConfidenceLevels() throws Exception {
        ...
        Block b2 = b1.createNextBlock(coinsTo2, null);
        BigInteger work2 = b2.getWork();
        Block b3 = b2.createNextBlock(coinsTo2, null);
        ...
        Block b4 = b1.createNextBlock(someOtherGuy, null);
        BigInteger work4 = b4.getWork();

        Block b5 = b4.createNextBlock(someOtherGuy, null);
        ...
        // Now we add another block to make the alternative chain longer.
        Block b6 = b5.createNextBlock(someOtherGuy, null);
        ...
        // ... and back to the first chain.
        Block b7 = b3.createNextBlock(coinsTo, null);
        BigInteger work7 = b7.getWork();
        Block b8 = b7.createNextBlock(coinsTo, null);
        ...
        Block b9 = b8.createNextBlock(someOtherGuy, null);
        Block b10 = b9.createNextBlock(someOtherGuy, null);
        chain.add(b9);
        chain.add(b10);
    ...
    public void coinbaseDeath() throws Exception {
        ...
        Block b2 = b1.createNextBlockWithCoinbase(coinsTo2.getPubKey(), null);
        Block b3 = b2.createNextBlock(someOtherGuy, null);
        ...
        for (int i = 0; i < unitTestParams.getSpendableCoinbaseDepth() - 2; i++) {
            firstTip = firstTip.createNextBlock(someOtherGuy, null);
            chain.add(firstTip);
        }
        // ... and spend.
        ...
        Block secondTip = b6;
        for (int i = 0; i < unitTestParams.getSpendableCoinbaseDepth() - 2; i++) {
            secondTip = secondTip.createNextBlock(someOtherGuy, null);
            chain.add(secondTip);
        }
        ...
        // ... and back to the first chain.
        Block b7 = firstTip.createNextBlock(someOtherGuy, null);
        Block b8 = b7.createNextBlock(someOtherGuy, null);
        ...
        Block b9 = secondTip.createNextBlock(someOtherGuy, null);
        Block b10 = b9.createNextBlock(someOtherGuy, null);
