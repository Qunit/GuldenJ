...
public final class Coin implements Monetary, Comparable<Coin>, Serializable {
    ...
    /**
     * 0.001 Bitcoins, also known as 1 mNLG.
     */
    public static final Coin MILLICOIN = COIN.divide(1000);

    /**
     * 0.000001 Bitcoins, also known as 1 µNLG or 1 uNLG.
     */
    ...
    private static final MonetaryFormat FRIENDLY_FORMAT = MonetaryFormat.NLG.minDecimals(2).repeatOptionalDecimals(1, 6).postfixCode();
    ...
    private static final MonetaryFormat PLAIN_FORMAT = MonetaryFormat.NLG.minDecimals(0).repeatOptionalDecimals(1, 8).noCode();

    /**
     * <p>
     * Returns the value as a plain string denominated in NLG.
     * The result is unformatted with no trailing zeroes.
     * For instance, a value of 150000 satoshis gives an output string of "0.0015" NLG
     * </p>
     */
