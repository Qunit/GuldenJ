...
import org.guldenj.core.Wallet.SendRequest;
...
import org.guldenj.store.WalletProtobufSerializer;
...
public class WalletTest extends TestWithWallet {
    ...
    public void autosaveDelayed() throws Exception {
        ...
        Block b2 = b1.createNextBlock(new ECKey().toAddress(params), null);
        chain.add(b2);
    ...
    public void testEmptyWallet() throws Exception {
        ...
        // Add just under 0.01
        StoredBlock block2 = new StoredBlock(block.getHeader().createNextBlock(outputKey, null), BigInteger.ONE, 2);
        ...
        StoredBlock block3 = new StoredBlock(block2.getHeader().createNextBlock(outputKey, null), BigInteger.ONE, 3);
