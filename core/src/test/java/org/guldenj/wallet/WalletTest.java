...
import org.guldenj.core.listeners.TransactionConfidenceEventListener;
...
import org.guldenj.core.PeerAddress;
...
import org.guldenj.signers.StatelessTransactionSigner;
import org.guldenj.signers.TransactionSigner;
import org.guldenj.store.BlockStoreException;
import org.guldenj.store.MemoryBlockStore;
import org.guldenj.testing.*;
import org.guldenj.utils.ExchangeRate;
import org.guldenj.utils.Fiat;
...
import org.guldenj.wallet.Protos.Wallet.EncryptionType;
...
import static org.guldenj.testing.FakeTxBuilder.*;
...
public class WalletTest extends TestWithWallet {
    ...
    public void doubleSpends() throws Exception {
        ...
        buf[43] = 0;  // Break the signature: guldenj won't check in SPV mode and this is easier than other mutations.
    ...
    public void spendToSameWallet() throws Exception {
        ...
        assertEquals(ZERO, wallet.getBalance());
        sendMoneyToWallet(AbstractBlockChain.NewBlockType.BEST_CHAIN, outbound1);
        // We should have a balance of 1 NLG after the block is received.
        assertEquals(coin1, wallet.getBalance());
    }
    ...
    public void autosaveImmediate() throws Exception {
        ...
        File f = File.createTempFile("guldenj-unit-test", null);
    ...
    public void opReturnTwoOutputsTest() throws Exception {
        // Tests sending transaction where one output transfers NLG, the other one writes OP_RETURN.
        receiveATransaction(wallet, myAddress);
        Transaction tx = new Transaction(PARAMS);
        Coin messagePrice = Coin.ZERO;
        Script script = ScriptBuilder.createOpReturnScript("hello world!".getBytes());
    ...
    public void totalReceivedSent() throws Exception {
        // Receive 4 NLG in 2 separate transactions
        ...
        // Send 3 NLG in a single transaction
