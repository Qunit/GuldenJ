...
public class PeerAddressTest
{
    ...
    public void testPeerAddressRoundtrip() throws Exception {
        ...
        String fromSpec = "010000000000000000000000000000000000ffff0a000001240f";
    ...
    public void testBitcoinSerialize() throws Exception {
        PeerAddress pa = new PeerAddress(InetAddress.getByName(null), 9231, 0);
        assertEquals("000000000000000000000000000000000000ffff7f000001240f",
