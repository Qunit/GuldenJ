 ...
 * {@link org.guldenj.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to the
...
public abstract class AbstractBlockChain {
    ...
    private boolean add(Block block, boolean tryConnecting,
        ...
        try {
            ...
            // article here for more details: http://code.google.com/p/guldenj/wiki/SecurityModel
            try {
                block.verifyHeader();
