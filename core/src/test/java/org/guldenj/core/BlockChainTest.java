...
import static org.guldenj.testing.FakeTxBuilder.createFakeBlock;
import static org.guldenj.testing.FakeTxBuilder.createFakeTx;
...
/*        ListenableFuture<StoredBlock> future = testNetChain.getHeightFuture(2);
    ...
    public void unconnectedBlocks() throws Exception {
        Block b1 = unitTestParams.getGenesisBlock().createNextBlock(coinbaseTo, null);
        Block b2 = b1.createNextBlock(coinbaseTo, null);
        Block b3 = b2.createNextBlock(coinbaseTo, null);
        // Connected.
...
/*        Block prev = unitTestParams.getGenesisBlock();
        ...
        for (int i = 0; i < unitTestParams.getInterval() - 1; i++) {
            Block newBlock = prev.createNextBlock(coinbaseTo, Utils.currentTimeSeconds(), null);
        ...
        try {
            chain.add(prev.createNextBlock(coinbaseTo, Utils.currentTimeSeconds(), null));
            fail();
        } catch (VerificationException e) {
        }
        // Create a new block with the right difficulty target given our blistering speed relative to the huge amount
        // of time it's supposed to take (set in the unit test network parameters).
        Block b = prev.createNextBlock(coinbaseTo, Utils.currentTimeSeconds(), null);
...
/*        assertTrue(testNetChain.add(getBlock1()));
    ...
    public void intraBlockDependencies() throws Exception {
        ...
        Block b1 = unitTestParams.getGenesisBlock().createNextBlock(somebodyElse, null);
    ...
    public void coinbaseTransactionAvailability() throws Exception {
        ...
        Block b1 = unitTestParams.getGenesisBlock().createNextBlockWithCoinbase(wallet.currentReceiveKey().getPubKey(), null);
        chain.add(b1);
        ...
        // Create a spend with the coinbase NLG to the address in the second wallet - this should now succeed.
    ...
    public void estimatedBlockTime() throws Exception {
        ...
        assertEquals(new SimpleDateFormat("yyyy-MM-dd'T'HH:mm:ss.SSSZ", Locale.US).parse("2005-10-20T21:20:00.000-0000"), d);
    }
