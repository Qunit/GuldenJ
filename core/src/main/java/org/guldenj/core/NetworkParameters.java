...
import org.guldenj.utils.VersionTally;
...
public abstract class NetworkParameters {
     ...
     */
    //fixme: GULDEN
    public static final byte[] ALERT_KEY = Utils.HEX.decode("073513ffe7147aba88d33aea4da129d8a2829c545526d5d854ab51d5778f4d0625431ba1c5a3245bdfe8736b127fdfdb488de72640727d37355c4c3a66c547efad");

    /** The string returned by getId() for the main, production network where people trade things. */
    public static final String ID_MAINNET = "org.gulden.production";
    /** The string returned by getId() for the testnet. */
    public static final String ID_TESTNET = "org.bitcoin.test";
    /** The string returned by getId() for regtest mode. */
    public static final String ID_REGTEST = "org.bitcoin.regtest";
    /** Unit test network. */
    public static final String ID_UNITTESTNET = "org.guldenj.unittest";
    ...
    private static Block createGenesis(NetworkParameters n) {
        ...
        try {
            ...
            //
            //   "On januari 1st the Dutch lost there beloved Gulden"
            byte[] bytes = Hex.decode("04ffff001d0104324f6e206a616e756172692031737420746865204475746368206c6f73742074686572652062656c6f7665642047756c64656e");
            t.addInput(new TransactionInput(n, t, bytes));
            ByteArrayOutputStream scriptPubKeyBytes = new ByteArrayOutputStream();
            scriptPubKeyBytes.write((byte)0);
            scriptPubKeyBytes.write(ScriptOpCodes.OP_CHECKSIG);
            t.addOutput(new TransactionOutput(n, t, COIN.multiply(0), scriptPubKeyBytes.toByteArray()));
        } catch (Exception e) {
            // Cannot happen.
     ...
     */
    public static final long MAX_COINS = 1680000000;
    ...
    /** Returns discovery objects for seeds implementing the Cartographer protocol. See {@link org.guldenj.net.discovery.HttpDiscovery} for more info. */
    ...
    /**
     * First byte of a base58 encoded address. See {@link org.guldenj.core.Address}. This is the same as acceptableAddressCodes[0] and
    ...
    /** First byte of a base58 encoded dumped private key. See {@link org.guldenj.core.DumpedPrivateKey}. */
    ...
    /**
     * The key used to sign {@link org.guldenj.core.AlertMessage}s. You can use {@link org.guldenj.core.ECKey#verify(byte[], byte[], byte[])} to verify
     * signatures using it.
     */
