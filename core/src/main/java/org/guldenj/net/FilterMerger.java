...
/**
 * <p>A reusable object that will calculate, given a list of {@link org.guldenj.core.PeerFilterProvider}s, a merged
 * {@link org.guldenj.core.BloomFilter} and earliest key time for all of them.
 * Used by the {@link org.guldenj.core.PeerGroup} class internally.</p>
 *
