 ...
 *
 * <p>Wallets can be serialized using either Java serialization - this is not compatible across versions of guldenj,
...
public class Wallet extends BaseTaggableObject implements Serializable, BlockChainListener, PeerFilterProvider, KeyBag, TransactionBag {
    ...
    public String toString(boolean includePrivateKeys, boolean includeTransactions, boolean includeExtensions,
        ...
        try {
            ...
            builder.append(String.format(Locale.US, "Wallet containing %s NLG (spendable: %s NLG) in:%n",
    ...
    public static class SendRequest {
         ...
         * (its value is ignored and set to {@link org.guldenj.core.Wallet#getBalance()} - the fees required
        ...
        /**
         * If not null, the {@link org.guldenj.wallet.CoinSelector} to use instead of the wallets default. Coin selectors are
    ...
    public void completeTx(SendRequest req) throws InsufficientMoneyException {
        ...
        try {
            ...
            // We need to know if we need to add an additional fee because one of our values are smaller than 0.01 NLG
