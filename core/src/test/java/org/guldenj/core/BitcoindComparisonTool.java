...
import org.guldenj.net.NioClient;
...
import org.guldenj.store.H2FullPrunedBlockStore;
...
/**
 * A tool for comparing the blocks which are accepted/rejected by bitcoind/guldenj
 * It is designed to run as a testnet-in-a-box network between a single bitcoind node and guldenj
