...
import org.guldenj.testing.TestWithWallet;
import org.guldenj.utils.Threading;
import org.guldenj.wallet.WalletFiles;
...
import static org.guldenj.protocols.channels.PaymentChannelCloseException.CloseReason;
...
public class ChannelConnectionTest extends TestWithWallet {
    ...
    private static Wallet roundTripClientWallet(Wallet wallet) throws Exception {
        ...
        org.guldenj.wallet.Protos.Wallet proto = WalletProtobufSerializer.parseToProto(new ByteArrayInputStream(bos.toByteArray()));
