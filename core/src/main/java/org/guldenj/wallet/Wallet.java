...
import org.guldenj.core.AbstractBlockChain;
import org.guldenj.core.Address;
import org.guldenj.core.BlockChain;
import org.guldenj.core.BloomFilter;
import org.guldenj.core.Coin;
import org.guldenj.core.Context;
import org.guldenj.core.ECKey;
import org.guldenj.core.FilteredBlock;
import org.guldenj.core.InsufficientMoneyException;
import org.guldenj.core.Message;
import org.guldenj.core.NetworkParameters;
import org.guldenj.core.Peer;
import org.guldenj.core.PeerFilterProvider;
import org.guldenj.core.PeerGroup;
import org.guldenj.core.ScriptException;
import org.guldenj.core.Sha256Hash;
import org.guldenj.core.StoredBlock;
import org.guldenj.core.Transaction;
import org.guldenj.core.TransactionBag;
import org.guldenj.core.TransactionBroadcast;
...
import org.guldenj.core.TransactionOutPoint;
import org.guldenj.core.TransactionOutput;
import org.guldenj.core.UTXO;
import org.guldenj.core.UTXOProvider;
import org.guldenj.core.UTXOProviderException;
import org.guldenj.core.Utils;
import org.guldenj.core.VarInt;
import org.guldenj.core.VerificationException;
import org.guldenj.core.TransactionConfidence.*;
import org.guldenj.crypto.*;
import org.guldenj.script.*;
import org.guldenj.signers.*;
import org.guldenj.utils.*;
import org.guldenj.wallet.Protos.Wallet.*;
import org.guldenj.wallet.WalletTransaction.*;
import org.guldenj.wallet.listeners.KeyChainEventListener;
import org.guldenj.wallet.listeners.ScriptsChangeEventListener;
import org.guldenj.wallet.listeners.WalletChangeEventListener;
import org.guldenj.wallet.listeners.WalletCoinsReceivedEventListener;
import org.guldenj.wallet.listeners.WalletCoinsSentEventListener;
import org.guldenj.wallet.listeners.WalletEventListener;
import org.guldenj.wallet.listeners.WalletReorganizeEventListener;
import org.slf4j.*;
 ...
 *
 * <p>To learn more about this class, read <b><a href="https://guldenj.github.io/working-with-the-wallet">
 ...
 * other objects, see the <a href="https://guldenj.github.io/getting-started">Getting started</a> tutorial
 ...
 * {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.guldenj.wallet.WalletFiles.Listener)}
...
public class Wallet extends BaseTaggableObject
     ...
     * {@link org.guldenj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS}. The returned key is stable until
    ...
    /**
     * An alias for calling {@link #currentKey(org.guldenj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.guldenj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #currentKey(org.guldenj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #currentAddress(org.guldenj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.guldenj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * {@link org.guldenj.wallet.DeterministicKeyChain}. When the parameter is
     * {@link org.guldenj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} the returned key is suitable for being put
    ...
    /**
     * An alias for calling {@link #freshKey(org.guldenj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.guldenj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
    ...
    /**
     * Returns address for a {@link #freshKey(org.guldenj.wallet.KeyChain.KeyPurpose)}
     */
    ...
    /**
     * An alias for calling {@link #freshAddress(org.guldenj.wallet.KeyChain.KeyPurpose)} with
     * {@link org.guldenj.wallet.KeyChain.KeyPurpose#RECEIVE_FUNDS} as the parameter.
     */
     ...
     * key, after loading a wallet produced by previous versions of guldenj. If the wallet is encrypted the key
     ...
     * If {@link Wallet#autosaveToFile(java.io.File, long, java.util.concurrent.TimeUnit, org.guldenj.wallet.WalletFiles.Listener)}
    ...
    /** See {@link org.guldenj.wallet.DeterministicKeyChain#setLookaheadSize(int)} for more info on this. */
    ...
    /** See {@link org.guldenj.wallet.DeterministicKeyChain#setLookaheadThreshold(int)} for more info on this. */
     ...
     * See {@link org.guldenj.wallet.DeterministicKeyChain#markKeyAsUsed(DeterministicKey)} for more info on this.
     */
     ...
     * @throws org.guldenj.core.ECKey.MissingPrivateKeyException if the seed is unavailable (watching wallet)
     */
    ...
    /**
     * Convenience wrapper around {@link Wallet#encrypt(org.guldenj.crypto.KeyCrypter,
     ...
     * of {@link org.guldenj.core.ECKey#getCreationTimeSeconds()}. This can return zero if at least one key does
     ...
     * you can use {@link org.guldenj.utils.Threading#waitForUserCode()} to block until the future had a
    ...
    public enum MissingSigsMode {
        ...
        USE_DUMMY_SIG,
        /**
         * If signature is missing, {@link org.guldenj.signers.TransactionSigner.MissingSignatureException}
    ...
    public FeeCalculation calculateFee(SendRequest req, Coin value, List<TransactionInput> originalInputs,
        ...
        while (true) {
            ...
            // If change is < 0.01 NLG, we will need to have at least minfee to be accepted by the network
     ...
     */
    public void setTransactionBroadcaster(@Nullable org.guldenj.core.TransactionBroadcaster broadcaster) {
     ...
     * @throws org.guldenj.wallet.DeterministicUpgradeRequiresPassword if key rotation requires the users password.
     */
