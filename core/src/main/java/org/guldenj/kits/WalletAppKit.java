...
import org.guldenj.protocols.channels.*;
...
/**
 * <p>Utility class that wraps the boilerplate needed to set up a new SPV guldenj app. Instantiate it with a directory
 ...
 * It is to make it easier to fit guldenj into GUI apps, which require a high degree of responsiveness on their main
 * thread which handles all the animation and user interaction. Even when blockingStart is false, initializing guldenj
...
public class WalletAppKit extends AbstractIdleService {
     ...
     * {@link org.guldenj.core.DownloadProgressTracker} is a good choice. This has no effect unless setBlockingStartup(false) has been called
     ...
     * block sync faster for new users - please refer to the documentation on the guldenj website
     * (https://guldenj.github.io/speeding-up-chain-sync) for further details.
     */
