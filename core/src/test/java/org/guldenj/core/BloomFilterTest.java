...
public class BloomFilterTest {
    ...
    public void walletTest() throws Exception {
        ...
        DumpedPrivateKey privKey = DumpedPrivateKey.fromBase58(params, "Rgz1vKxL6eJTdsZ9DC8F29WP4jXyKngJjqkUiFsp4wSYY9hQZrZa");

        Address addr = privKey.getKey().toAddress(params);
        assertTrue(addr.toString().equals("GbMFoq3q1KyrcTFzCi255rEzKJDQ5HULkj"));
        ...
        // Value generated by Bitcoin Core
        assertTrue(Arrays.equals(HEX.decode("0889e5230ae51d4e86080000000000000002"), filter.unsafeBitcoinSerialize()));
    }
}
