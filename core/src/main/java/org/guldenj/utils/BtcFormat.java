...
import org.guldenj.utils.BtcAutoFormat.Style;
import static org.guldenj.utils.BtcAutoFormat.Style.*;
 ...
 * String c = f.format(Coin.COIN);                <strong>// "NLG 1.00"</strong>
 * String k = f.format(Coin.COIN.multiply(1000)); <strong>// "NLG 1,000.00"</strong>
 * String m = f.format(Coin.COIN.divide(1000));   <strong>// "mNLG 1.00"</strong>
 ...
 * code, such as <code>"NLG"</code>, to indicate the units of denomination, while the
 ...
 * <code>1.0000 NLG</code>, or one bitcoin, in millibitcoins, one shifts the decimal point
 * three places, that is, to <code>1000.0 mNLG</code>.
 *
 * <h3>Construction</h3>
 *
 ...
 * <blockquote><pre>
 * BtcFormat f = BtcFormat.getInstance();
 * String s = f.format(Coin.COIN); <strong>// "NLG 1.00"</strong>
 * </pre></blockquote>
 *
 ...
 *
 * <blockquote><pre>
 * <strong>// Next line returns "1,00 NLG"</strong>
 ...
 * method.  This argument can be either a {@link org.guldenj.core.Coin}-type object or a
 ...
 * <strong>// next line formats the value as "987.654.321,23 µNLG"</strong>
 * String output = de.format(valueOf(98765432123L), new StringBuffer(), currField);
 * <strong>// next line sets variable currencyCode to "µNLG"</strong>
 ...
 * <strong>// variable coded will be set to "kNLG 1.23"</strong>
 ...
 * <code>µNLG</code> or other appropriate permutations of those characters.  Additionally, if
...
public abstract class BtcFormat extends Format {
    ...
    /** The conventional international currency code for bitcoins: "NLG" */
    private static final String COIN_CODE = "NLG";
     ...
     * currency code, for example "<code>NLG</code>", to indicate that denomination.  The
    ...
    /**
     * Return a new auto-denominating instance that will indicate units using a currency
     * code, for example, <code>"NLG"</code>.  Formatting and parsing will be done
     * according to the default locale.
     */
     ...
     * <code>"NLG"</code>.  The returned object will format the fraction-part of numbers using
     * the given number of decimal places, or fewer as necessary to avoid giving a place to
     * fractional satoshis.  Formatting and parsing will be done according to the default
     * locale.
     */
     ...
     * units using a currency code, for example, <code>"mNLG"</code>.
     */
     ...
     * <code>"mNLG"</code>.  The returned object will format the fraction-part of numbers using
     * the given number of decimal places, or fewer as necessary to avoid giving a place to
     * fractional satoshis.
     */
     ...
     * <code>"฿"</code>, or code, such as <code>"mNLG"</code>, depending on the value of
     ...
     * <code>"mNLG"</code>, depending on the value of the first argument.  The returned object
     ...
     * "<code>NLG</code>", or symbol, such as "<code>฿</code>", depending on the value
     ...
     * such as <code>"mNLG"</code>, or symbol, such as "<code>฿</code>",
    ...
    /**
      ...
      * {@link org.guldenj.core.Coin} object that represents the parsed value.
      * @see java.text.NumberFormat */
    @Override
