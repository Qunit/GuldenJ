/**
 * Copyright 2014 The guldenj developers.
 *
 ...
 * {@link org.guldenj.crypto.DeterministicHierarchy}, to derive all the keys in the keychain from a master seed.
 ...
 * written down on paper or, when represented using a BIP 39 {@link org.guldenj.crypto.MnemonicCode},
 ...
 * {@link org.guldenj.crypto.DeterministicKey#serializePubB58(org.guldenj.core.NetworkParameters)}. The resulting "xpub..." string encodes
 * sufficient information about the account key to create a watching chain via
 * {@link org.guldenj.crypto.DeterministicKey#deserializeB58(org.guldenj.crypto.DeterministicKey, String, org.guldenj.core.NetworkParameters)}
 * (with null as the first parameter) and then
 * {@link DeterministicKeyChain#DeterministicKeyChain(org.guldenj.crypto.DeterministicKey)}.</p>
 *
 * <p>This class builds on {@link org.guldenj.crypto.DeterministicHierarchy} and
 * {@link org.guldenj.crypto.DeterministicKey} by adding support for serialization to and from protobufs,
...
public class DeterministicKeyChain implements EncryptableKeyChain {
    ...
    // m / 44' / 0' / 0'
    public static final int COIN_TYPE = 87;
    public static final ImmutableList<ChildNumber> BIP44_ACCOUNT_ZERO_PATH =
            ImmutableList.of(new ChildNumber(44, true), new ChildNumber(COIN_TYPE, true), ChildNumber.ZERO_HARDENED);
    ...
    public List<DeterministicKey> getKeys(KeyPurpose purpose, int numberOfKeys) {
        ...
        try {
            ...
            for (int i = 0; i < numberOfKeys; i++) {
                ...
                // by any real problem reports from guldenj users, but I've heard of cases via the grapevine of
     ...
     * The returned key can be serialized and then passed into {@link #watch(org.guldenj.crypto.DeterministicKey)}
     ...
     * @see org.guldenj.wallet.MarriedKeyChain
     */
