 ...
 * <a href="https://guldenj.github.io/working-with-transactions">"Working with transactions"</a> in the
...
public class Transaction extends ChildMessage {
     ...
     */
    public static final Coin REFERENCE_DEFAULT_MIN_TX_FEE = Coin.valueOf(5000); // 0.05 mNLG

    /**
     * If using this feePerKb, transactions will get confirmed within the next couple of blocks.
     * This should be adjusted from time to time. Last adjustment: March 2016.
     */
    public static final Coin DEFAULT_TX_FEE = Coin.valueOf(50000); // 0.5 mNLG
