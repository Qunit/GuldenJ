// This file shows how to use guldenj from Javascript.
// To run, grab the guldenj bundled JAR and then do something like this:
//
//   jjs -cp guldenj-0.12-bundled.jar demo.js
//
...
//
//   jjs -cp guldenj-0.12-bundled.jar
//
...
//
//   jjs -cp guldenj-0.12-bundled.jar:$slf4fj demo.js
//
...
// Nashorn, unlike V8, is thread safe (because it runs on the JVM). And guldenj is a threaded library. This means you
