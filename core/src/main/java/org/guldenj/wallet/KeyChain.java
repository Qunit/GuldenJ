...
public interface KeyChain {
    ...
    /** Returns a list of keys serialized to the guldenj protobuf format. */
     ...
     *
     * <p>See the docs for {@link org.guldenj.core.BloomFilter#BloomFilter(int, double, long)} for a brief
