...
/**
 * <p>A KeyChainGroup is used by the {@link org.guldenj.core.Wallet} and
...
public class KeyChainGroup implements KeyBag {
     ...
     *
     * @throws org.guldenj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     * KeyCrypter to use is {@link org.guldenj.crypto.KeyCrypterScrypt}.
     *
     * @throws org.guldenj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
