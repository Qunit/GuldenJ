...
import org.guldenj.core.Monetary;
...
public final class MonetaryFormat {
    ...
    /** Standard format for the NLG denomination. */
    public static final MonetaryFormat NLG = new MonetaryFormat().shift(0).minDecimals(2).repeatOptionalDecimals(2, 3);
    /** Standard format for the mNLG denomination. */
    public static final MonetaryFormat MNLG = new MonetaryFormat().shift(3).minDecimals(2).optionalDecimals(2);
    /** Standard format for the µNLG denomination. */
    public static final MonetaryFormat UNLG = new MonetaryFormat().shift(6).minDecimals(0).optionalDecimals(2);
    /** Standard format for fiat amounts. */
    public static final MonetaryFormat FIAT = new MonetaryFormat().shift(0).minDecimals(2).repeatOptionalDecimals(2, 1);
    /** Standard format for RAW amounts */
    public static final MonetaryFormat RAW = new MonetaryFormat().shift(0).minDecimals(8).noCode();
    /** Currency code for base 1 Bitcoin. */
    public static final String CODE_NLG = "NLG";
    /** Currency code for base 1/1000 Bitcoin. */
    public static final String CODE_MNLG = "mNLG";
    /** Currency code for base 1/1000000 Bitcoin. */
    public static final String CODE_UNLG = "µNLG";
    ...
    /**
     * Set number of digits to shift the decimal separator to the right, coming from the standard NLG notation that was
    ...
    public MonetaryFormat() {
        ...
        this.codes[0] = CODE_NLG;
        this.codes[3] = CODE_MNLG;
        this.codes[6] = CODE_UNLG;
        this.codeSeparator = ' ';
    ...
    /**
     * Parse a human readable coin value to a {@link org.guldenj.core.Coin} instance.
     * 
    ...
    /**
     * Parse a human readable fiat value to a {@link org.guldenj.utils.Fiat} instance.
     * 
     * @throws NumberFormatException
     *             if the string cannot be parsed for some reason
     */
