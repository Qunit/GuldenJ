 ...
 * the lightweight SPV mode, a {@link org.guldenj.store.SPVBlockStore} is the right choice.</p>
 *
 ...
 * {@link org.guldenj.store.H2FullPrunedBlockStore} implements full verification, which is equivalent to
...
public abstract class AbstractBlockChain {
    ...
    private boolean add(Block block, boolean tryConnecting,
        ...
        try {
            ...
            // article here for more details: https://guldenj.github.io/security-model
            try {
                block.verifyHeader();
