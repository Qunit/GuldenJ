 ...
 * {@link org.guldenj.store.SPVBlockStore}s. They are not used by fully validating mode, which instead has a
...
public class CheckpointManager {
    ...
    /** Loads the default checkpoints bundled with guldenj */
    ...
    /** Returns a checkpoints stream pointing to inside the guldenj JAR */
