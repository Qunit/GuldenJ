 ...
 * {@link org.guldenj.net.AbstractTimeoutHandler} and timeout is automatically disabled (using
 * {@link org.guldenj.net.AbstractTimeoutHandler#setTimeoutEnabled(boolean)}) once the version
...
public class Peer extends PeerSocketHandler {
     ...
     * {@link org.guldenj.net.NioClientManager#openConnection(java.net.SocketAddress, org.guldenj.net.StreamParser)}
     * or
     * {@link org.guldenj.net.NioClient#NioClient(java.net.SocketAddress, org.guldenj.net.StreamParser, int)}.</p>
     *
    ...
    /**
     * <p>Construct a peer that reads/writes from the given block chain. Transactions stored in a {@link org.guldenj.core.TxConfidenceTable}
    ...
    private void processVersionMessage(VersionMessage m) throws ProtocolException {
        ...
        // guldenj is a client mode implementation. That means there's not much point in us talking to other client
    ...
    private void processAlert(AlertMessage m) {
        try {
            ...
            // BigInteger implementations! See https://github.com/guldenj/guldenj/issues/526 for discussion. As
     ...
     * Once the pong is received the value returned by {@link org.guldenj.core.Peer#getLastPingTime()} is
     * updated.
    ...
    /**
     * Returns the elapsed time of the last ping/pong cycle. If {@link org.guldenj.core.Peer#ping()} has never
    ...
    /**
     * Returns a moving average of the last N ping/pong cycles. If {@link org.guldenj.core.Peer#ping()} has never
